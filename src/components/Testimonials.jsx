    ...
    <section className="pb-28">
      <div className="container relative">
        <div className="w-14 z-10 absolute left-30 top-[-2rem] max-w-full">
            <img src="../../src/assets/bg-quotes.png" alt="quets" className="w-full h-full object-contain"/>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-white relative z-10 px-2">
          ...
          <div className="flex items-center gap-4 w-full">
              <img src={`../../src/assets/${testimonial.img}`} alt="img" className="w-[2rem] h-[2rem] rounded-full object-contain"/>
            <div>
